                  ...
                  <div className="item-content">
                    <div className="wrap-newletter-footer">
                      <form action="#" className="frm-newletter" id="frm-newletter">
                        <input type="email" className="input-email" name="email" defaultValue="" placeholder="Enter your email address" />
                ...
                <div className="wrap-footer-item">
                  ...
                  <div className="item-content">
                    <div className="wrap-list-item wrap-gallery">
                      <img src="../../assets/frontend/images/payment.png" style={{maxWidth: '260px'}} alt="Payment" />
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div className="wrap-footer-item">
                  ...
                  <div className="item-content">
                    <div className="wrap-list-item apps-list">
                      <ul>
                        <li><Link to="#" className="link-to-item" title="our application on apple store"><figure>
                          <img src="../../assets/frontend/images/brands/apple-store.png" alt="apple store" width="128" height="36" /></figure></Link></li>
                        <li><Link to="#" className="link-to-item" title="our application on google play store"><figure>
                          <img src="../../assets/frontend/images/brands/google-play-store.png" alt="google play store" width="128" height="36" /></figure></Link></li>
                      </ul>
                    </div>
                  </div>
                </div>
              ...
              <div className="back-link-box">
                ...
                <div className="back-link-row">
                  <ul className="list-back-link" >
                    ...
                    <li><Link to="#" className="redirect-back-link" title="Mobiles Karbonn">Mobiles Karbonn</Link></li>
                    <li><Link to="#" className="redirect-back-link" title="Mobiles Viva">Mobiles Viva</Link></li>
                    <li><Link to="#" className="redirect-back-link" title="Mobiles Intex">Mobiles Intex</Link></li>
                    <li><Link to="#" className="redirect-back-link" title="Mobiles Micrumex">Mobiles Micrumex</Link></li>
                    <li><Link to="#" className="redirect-back-link" title="Mobiles Bsus">Mobiles Bsus</Link></li>
                    <li><Link to="#" className="redirect-back-link" title="Mobiles Samsyng">Mobiles Samsyng</Link></li>
                    <li><Link to="#" className="redirect-back-link" title="Mobiles Lenova">Mobiles Lenova</Link></li>
                  </ul>

                  <ul className="list-back-link" >
                    <li><span className="row-title">Tablets:</span></li>
                    <li><Link to="#" className="redirect-back-link" title="Plesc YPads">Plesc YPads</Link></li>
                    <li><Link to="#" className="redirect-back-link" title="Samsyng Tablets" >Samsyng Tablets</Link></li>
                    <li><Link to="#" className="redirect-back-link" title="Qindows Tablets" >Qindows Tablets</Link></li>
                    <li><Link to="#" className="redirect-back-link" title="Calling Tablets" >Calling Tablets</Link></li>
                    <li><Link to="#" className="redirect-back-link" title="Micrumex Tablets" >Micrumex Tablets</Link></li>
                    <li><Link to="#" className="redirect-back-link" title="Lenova Tablets Bsus" >Lenova Tablets Bsus</Link></li>
                    <li><Link to="#" className="redirect-back-link" title="Tablets iBall" >Tablets iBall</Link></li>
                    <li><Link to="#" className="redirect-back-link" title="Tablets Swipe" >Tablets Swipe</Link></li>
                    <li><Link to="#" className="redirect-back-link" title="Tablets TVs, Audio" >Tablets TVs, Audio</Link></li>
                  </ul>

                  <ul className="list-back-link" >
                    <li><span className="row-title">Fashion:</span></li>
                    <li><Link to="#" className="redirect-back-link" title="Sarees Silk" >Sarees Silk</Link></li>
                    <li><Link to="#" className="redirect-back-link" title="sarees Salwar" >sarees Salwar</Link></li>
                    <li><Link to="#" className="redirect-back-link" title="Suits Lehengas" >Suits Lehengas</Link></li>
                    <li><Link to="#" className="redirect-back-link" title="Biba Jewellery" >Biba Jewellery</Link></li>
                    <li><Link to="#" className="redirect-back-link" title="Rings Earrings" >Rings Earrings</Link></li>
                    <li><Link to="#" className="redirect-back-link" title="Diamond Rings" >Diamond Rings</Link></li>
          ...
          <div className="container">
            ...
            <div className="coppy-right-item item-right">
              <div className="wrap-nav horizontal-nav">
                <ul>
                  <li className="menu-item"><Link to="about-us.html" className="link-term">About us</Link></li>								
                  <li className="menu-item"><Link to="privacy-policy.html" className="link-term">Privacy Policy</Link></li>
                  <li className="menu-item"><Link to="terms-conditions.html" className="link-term">Terms & Conditions</Link></li>
                  <li className="menu-item"><Link to="return-policy.html" className="link-term">Return Policy</Link></li>								
                </ul>
              </div>
            </div>
